...
public class RefreshableListView extends ListView implements OnScrollListener
{
	...
	public void onRefreshComplete()
	{
		...
		headerRelativeLayout.setPadding(headerRelativeLayout.getPaddingLeft(),
				-1 * HEADER_HEIGHT+50, 0, headerRelativeLayout.getPaddingBottom());
		
		SimpleDateFormat format =new SimpleDateFormat("yyyy, MMM dd. HH:mm:ss");
		String date=format.format(new Date());
		lastUpdateDateTextView.setText(getContext().getString(R.string.lastupdated) + date);
	...
	{
		headerRelativeLayout.setPadding(headerRelativeLayout.getPaddingLeft(),
				HEADER_TOP+50, 0, headerRelativeLayout.getPaddingBottom());
